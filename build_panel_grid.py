...
panel = prepare_gridded_panel_data(grid_polygon='square', localities='Global', stepsize=4.0,
                                        ...
                                        clim_index = 'nino34',  # 'nino3', 'nino34', 'dmi', 'dmi_noenso'
                                        response_var='binary',  # 'count' or 'binary'
                                        telecon_path = '/Users/tylerbagwell/Documents/Rice_University/CCCV/data/cccv_data/processed_teleconnections/psi_mrsosNINO34.nc',
...
panel.to_csv('/Users/tylerbagwell/Documents/Rice_University/CCCV/data/panel_datasets/onset_datasets_grid/Onset_Binary_Global_mrsosNINO34_square4_wGeometry.csv', index=False)
