...
from utils.prepare_index import *
...
def prepare_gridded_panel_data(grid_polygon, localities, stepsize, nlag_cindex, nlag_conflict, clim_index, response_var='count', telecon_path=None, add_weather_controls=False, show_grid=False, show_gridded_aggregate=False):
    ...
    if (show_gridded_aggregate==True):
        ...
        plt.tight_layout()
        plt.savefig('/Users/tylerbagwell/Desktop/RobMAP.png', dpi=300, bbox_inches='tight', pad_inches=0.1)
        plt.show()
...
panel = prepare_gridded_panel_data(grid_polygon='square', localities='Global', stepsize=4.0,
                                        ...
                                        telecon_path = '/Users/tylerbagwell/Documents/Rice_University/CCCV/data/cccv_data/processed_teleconnections/psi_DMI_type1.nc',
                                        add_weather_controls=False,
                                        show_grid=True, show_gridded_aggregate=True)
panel.to_csv('/Users/tylerbagwell/Documents/Rice_University/CCCV/data/panel_datasets/onset_datasets_grid/Onset_Count_Global_DMItype1_square4.csv', index=False)
# panel.to_csv('/Users/tylerbagwell/Documents/Rice_University/CCCV/data/panel_datasets/onset_datasets_grid/Onset_Binary_Global_DMItype1_square4_wGeometry.csv', index=False)
