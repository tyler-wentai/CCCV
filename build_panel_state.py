...
panel = initalize_state_onset_panel(panel_start_year=1950,
                                    panel_end_year=2023,
                                    telecon_path = '/Users/tylerbagwell/Desktop/cccv_data/processed_teleconnections/psi_mrsosEEI.nc',
...
panel.to_csv('/Users/tylerbagwell/Desktop/panel_datasets/onset_datasets_state/Onset_Binary_GlobalState_mrsosEEI.csv', index=False)
print(panel)
