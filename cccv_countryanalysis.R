...
panel_data_path <- '/Users/tylerbagwell/Desktop/panel_datasets/onset_datasets_state/Onset_Binary_GlobalState_DMIspi6.csv'
...
dat_help <- subset(dat, psi > 0 & psi < 0.37100641)
sum(dat_help$conflict_binary)


sort(subset(dat, loc_id=='loc_1')$cindex_lag0)
...
plot(ce, ask = FALSE)
ce_data <- ce$cindex_lag0y
write.csv(ce_data, file = "/Users/tylerbagwell/Desktop/panel_datasets/results_for_onsets/CE_cindex_lag0y_Onset_Binary_Global_DMI_square4_group_strong95.csv", row.names = FALSE)

#write.csv(dat_agg$cindex_lag0y, file = "/Users/tylerbagwell/Desktop/panel_datasets/results_for_onsets/cindex_lag0y_Onset_Binary_Global_NINO3_square4.csv", row.names = FALSE)
