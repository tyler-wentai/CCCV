...
file_path_VAR1 = '/Users/tylerbagwell/Desktop/raw_climate_data/spi6_ERA5_mon_194001-202212.nc' # air temperature 2 meter
var1str = 'spi6'
...
if anom_file1.exists():
    ...
    np.save('/Users/tylerbagwell/Desktop/cccv_data/processed_climate_data/spi6_anom_ERA5_0d5' + str(start_year) + str(end_year) + '_FINAL.npy', var1_std)
...
pathA_str = '/Users/tylerbagwell/Desktop/cccv_data/processed_teleconnections/psi' + var1str + '_' + clim_index +'_FINAL.nc'
...
pathB_str = '/Users/tylerbagwell/Desktop/cccv_data/processed_teleconnections/psiMonthly' + var1str + '_' + clim_index +'_FINAL.nc'
