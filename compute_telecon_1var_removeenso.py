...
anom_file1 = Path(f'/Users/tylerbagwell/Documents/Rice_University/CCCV/data/cccv_data/processed_climate_data/{var1str}_anom_ERA5_mon_v02_{start_year}{end_year}_FINAL.npy')
...
if anom_file1.exists():
    ...
    np.save(f'/Users/tylerbagwell/Documents/Rice_University/CCCV/data/cccv_data/processed_climate_data/{var1str}_anom_ERA5_mon_v02_{start_year}{end_year}_FINAL.npy', var1_std)
...
for i in range(n_lat):
    ...
    for j in range(n_long):
        ...
        for k in range(1,int(n_months+1),1):
            ...
            has_nan = var_ts[[var1str, 'avg_ANOM', 'avg_ENSO']].isna().any().any()
            if not has_nan:
...
psi_array = xr.DataArray(data = psi,
                        ...
                        dims = ["lat", "lon"],
                        attrs=dict(
                            description="Signed teleconnection strength (Psi) inspired by Cai et al. 2024 method using ERA5 mrsos controlling for ENSO via partial correlations with NDJ-NINO3.",
...
pathA_str = '/Users/tylerbagwell/Documents/Rice_University/CCCV/data/cccv_data/processed_teleconnections/psi_signed_' + clim_index +'_type1_ensoremoved.nc'
...
psiMonthly_array = xr.DataArray(data = monthly_psi,
                        ...
                        dims = ["month", "lat", "lon"],
                        attrs=dict(
                            description="Monthly signed teleconnection strength (Psi) inspired by Cai et al. 2024 method using ERA5 mrsos controlling for ENSO via partial correlations with NDJ-NINO3.",
                            psi_calc_start_date = str(datetime(start_year, 1, 1, 0, 0, 0)),
                            psi_calc_end_date = str(datetime(end_year, 12, 1, 0, 0, 0)),
                            climate_index_used = clim_index,
                            resolution = resolution)
...
pathB_str = '/Users/tylerbagwell/Documents/Rice_University/CCCV/data/cccv_data/processed_teleconnections/psiMonthly_signed_' + clim_index +'_type1_ensoremoved.nc'
