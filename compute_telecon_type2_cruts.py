...
clim_index = 'DMI'
resolution = 0.5 #CRUTS is 0.5 deg. resolution

start_year  = 1950
end_year    = 2023

#################################################################
########### USE TO CONSTRUCT CONSOLIDATED NETCDF ################
#################################################################
# files_tmp = [
#     "/Users/tylerbagwell/Desktop/cru_ts4.09_tmp_data/cru_ts4.09.1941.1950.tmp.dat.nc",
#     "/Users/tylerbagwell/Desktop/cru_ts4.09_tmp_data/cru_ts4.09.1951.1960.tmp.dat.nc",
#     "/Users/tylerbagwell/Desktop/cru_ts4.09_tmp_data/cru_ts4.09.1961.1970.tmp.dat.nc",
#     "/Users/tylerbagwell/Desktop/cru_ts4.09_tmp_data/cru_ts4.09.1971.1980.tmp.dat.nc",
#     "/Users/tylerbagwell/Desktop/cru_ts4.09_tmp_data/cru_ts4.09.1981.1990.tmp.dat.nc",
#     "/Users/tylerbagwell/Desktop/cru_ts4.09_tmp_data/cru_ts4.09.1991.2000.tmp.dat.nc",
#     "/Users/tylerbagwell/Desktop/cru_ts4.09_tmp_data/cru_ts4.09.2001.2010.tmp.dat.nc",
#     "/Users/tylerbagwell/Desktop/cru_ts4.09_tmp_data/cru_ts4.09.2011.2020.tmp.dat.nc",
#     "/Users/tylerbagwell/Desktop/cru_ts4.09_tmp_data/cru_ts4.09.2021.2024.tmp.dat.nc",
# ]
...
# ]
# ds1 = xr.open_mfdataset(files_tmp, combine="by_coords", parallel=True)
# ds1.to_netcdf("/Users/tylerbagwell/Desktop/cru_ts4.09_tmp_data/cru_ts4.09.tmp.dat_consolidated.nc")
# ds2 = xr.open_mfdataset(files_pre, combine="by_coords", parallel=True)
# ds2.to_netcdf("/Users/tylerbagwell/Desktop/cru_ts4.09_pre_data/cru_ts4.09.pre.dat_consolidated.nc")
#################################################################
#################################################################

path_var1 = "/Users/tylerbagwell/Desktop/cru_ts4.09_tmp_data/cru_ts4.09.tmp.dat_consolidated.nc"
path_var2 = "/Users/tylerbagwell/Desktop/cru_ts4.09_pre_data/cru_ts4.09.pre.dat_consolidated.nc"

ds1 = xr.open_dataset(path_var1)
ds2 = xr.open_dataset(path_var2)


# ds1 = ds1.assign_coords(valid_time=ds1.valid_time.dt.floor('D'))
# ds2 = ds2.assign_coords(valid_time=ds2.valid_time.dt.floor('D'))

t1 = ds1.indexes["time"]  # pandas.DatetimeIndex
new_t1 = t1.to_period("M").to_timestamp()  # YYYY-MM-01 00:00:00
ds1 = ds1.assign_coords(time=new_t1).sortby("time")
ds1 = ds1.sel(time=~ds1.indexes["time"].duplicated())
ds1 = ds1.rename({'lon': 'longitude'})
ds1 = ds1.rename({'lat': 'latitude'})


t2 = ds2.indexes["time"]  # pandas.DatetimeIndex
new_t2 = t2.to_period("M").to_timestamp()  # YYYY-MM-01 00:00:00
ds2 = ds2.assign_coords(time=new_t2).sortby("time")
ds2 = ds2.sel(time=~ds2.indexes["time"].duplicated())
ds2 = ds2.rename({'lon': 'longitude'})
ds2 = ds2.rename({'lat': 'latitude'})
...
anom_file1 = Path('/Users/tylerbagwell/Documents/Rice_University/CCCV/data/cccv_data/processed_climate_data/tmp_anom_CRUTS_0d5_19502023_FINAL.npy')
anom_file2 = Path('/Users/tylerbagwell/Documents/Rice_University/CCCV/data/cccv_data/processed_climate_data/pre_anom_CRUTS_0d5_19502023_FINAL.npy')
...
if anom_file1.exists() and anom_file2.exists():
    ...
    for i, j in tqdm(itertools.product(range(n_lat), range(n_long)),
                    total=n_lat*n_long,
                    desc="Processing grid cell anomalies"):
        # your logic here
        if np.all(np.isnan(var1_common[:, i, j])):
            var1_std[:, i, j] = var1_common[:, i, j]
        else:
            var1_std[:, i, j] = detrend_then_standardize_monthly(var1_common[:, i, j])

        if np.all(np.isnan(var2_common[:, i, j])):
            var2_std[:, i, j] = var2_common[:, i, j]
        else:
            var2_std[:, i, j] = detrend_then_standardize_monthly(var2_common[:, i, j], israin=True)

    np.save('/Users/tylerbagwell/Documents/Rice_University/CCCV/data/cccv_data/processed_climate_data/tmp_anom_CRUTS_0d5_' + str(start_year) + str(end_year) + '_FINAL.npy', var1_std)
    np.save('/Users/tylerbagwell/Documents/Rice_University/CCCV/data/cccv_data/processed_climate_data/pre_anom_CRUTS_0d5_' + str(start_year) + str(end_year) + '_FINAL.npy', var2_std)
...
psi_array = xr.DataArray(data = psi,
                        ...
                        dims = ["lat", "lon"],
                        attrs=dict(
                            description="Teleconnection strength (Psi) using partial correlations inspired by Callahan and Mankin 2023 method using CRUTS tmp and pre.",
                            psi_calc_start_date = str(datetime(start_year, 1, 1, 0, 0, 0)),
                            psi_calc_end_date = str(datetime(end_year, 12, 1, 0, 0, 0)),
                            climate_index_used = clim_index,
                            resolution = resolution)
...
pathA_str = '/Users/tylerbagwell/Documents/Rice_University/CCCV/data/cccv_data/processed_teleconnections/psi_' + clim_index +'_type2_CRUTS.nc'
...
psiMonthly_array = xr.DataArray(data = monthly_psi,
                        ...
                        dims = ["month", "lat", "lon"],
                        attrs=dict(
                            description="Monthly raw teleconnection strength (Psi_m) using partial correlations inspired by Callahan and Mankin 2023 method using CRUTS tmp and pre.",
                            psi_calc_start_date = str(datetime(start_year, 1, 1, 0, 0, 0)),
                            psi_calc_end_date = str(datetime(end_year, 12, 1, 0, 0, 0)),
                            climate_index_used = clim_index,
                            resolution = resolution)
...
pathB_str = '/Users/tylerbagwell/Documents/Rice_University/CCCV/data/cccv_data/processed_teleconnections/psiMonthly_' + clim_index +'_type2_CRUTS.nc'
