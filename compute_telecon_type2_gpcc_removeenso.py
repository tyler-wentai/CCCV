...
for i in range(n_lat):
    ...
    for j in range(n_long):
        ...
        for k in range(1,int(n_months+1),1):
            ...
            if not has_nan:
                corr_1 = partial_corr(data=var_ts, x='avg_ANOM', y=var1str, covar='avg_ENSO')    # partial corr to remove ENSO influence
                corr_2 = partial_corr(data=var_ts, x='avg_ANOM', y=var2str, covar='avg_ENSO')    # partial corr to remove ENSO influence
...
pathA_str = '/Users/tylerbagwell/Documents/Rice_University/CCCV/data/cccv_data/processed_teleconnections/psi_' + clim_index +'_type2_GPCC_ensoremoved.nc'
...
pathB_str = '/Users/tylerbagwell/Documents/Rice_University/CCCV/data/cccv_data/processed_teleconnections/psiMonthly_' + clim_index +'_type2_GPCC_ensoremoved.nc'
