...
This archive contains low-resolution versions of the population count grids, 
both UN-adjusted and unadjusted, in ASCII format. The raster data are at 0.25 
degrees (15 arc-minutes) resolution and contain the following data:

p90g15		population counts in 1990, unadjusted
p90ag15		population counts in 1990, adjusted to match UN totals
