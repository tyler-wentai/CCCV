...
#
def prepare_panel_data(localities, nlag_psi, nlag_conflict, clim_index, telecon_path=None, show_grid=False, show_gridded_aggregate=False):
    """
    ...
    # create polygon grid
    polygons_gdf = create_grid(localities=localities, show_grid=show_grid)

    print(polygons_gdf[polygons_gdf['SOVEREIGNT']=='China'])
    print(len(set(polygons_gdf['SOVEREIGNT'])))
