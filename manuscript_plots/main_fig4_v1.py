...
# teleA
pathA = '/Users/tylerbagwell/Desktop/panel_datasets/onset_datasets_state/Onset_Binary_GlobalState_mrsosNINO3_wGeometry.csv'
...
# teleB
pathB = '/Users/tylerbagwell/Desktop/panel_datasets/onset_datasets_grid/Onset_Binary_Global_mrsosNINO3_square4_wGeometry.csv'
...
def draw_map(ax, label, cindex, tele_gdf, spatial_agg_type, cmap, nbin, threshold):
    gl = ax.gridlines(
    crs=ccrs.PlateCarree(),
    draw_labels={
        'bottom': True,
    ...
    #
    # x, y = gdf_onset['onset_lon'].values, gdf_onset['onset_lat'].values
    # ax.scatter(x, y, color='springgreen', edgecolor='black', linewidth=0.75, s=5.0, marker='o', alpha=0.5,
    #            transform=ccrs.PlateCarree(), zorder=5)


    # HISTORGRAM ON COLORBAR
    cbar_ax = gdf_plot.get_figure().axes[-1]
    cbar_ax.yaxis.set_major_formatter(mticker.FormatStrFormatter('%.1f'))
    cbar_ax.tick_params(labelsize=9)
...
plt.tight_layout()
plt.savefig('/Users/tylerbagwell/Desktop/manuscript_plots/Main_fig4_v1.png', dpi=300, pad_inches=0.01)
plt.show()