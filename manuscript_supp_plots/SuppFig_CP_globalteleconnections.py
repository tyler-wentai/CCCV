...
# teleA
pathA = '/Users/tylerbagwell/Documents/Rice_University/CCCV/data/panel_datasets/onset_datasets_state/Onset_Binary_GlobalState_ECItype2_wGeometry.csv'
...
# teleB
pathB = '/Users/tylerbagwell/Documents/Rice_University/CCCV/data/panel_datasets/onset_datasets_grid/Onset_Binary_Global_ECItype2_square4_wGeometry.csv'
...
# teleC
pathC = '/Users/tylerbagwell/Documents/Rice_University/CCCV/data/panel_datasets/onset_datasets_state/Onset_Binary_GlobalState_mrsosECI_wGeometry.csv'
...
# teleD
pathD = '/Users/tylerbagwell/Documents/Rice_University/CCCV/data/panel_datasets/onset_datasets_grid/Onset_Binary_Global_mrsosECI_square4_wGeometry.csv'
...
def draw_map(ax, var, label, cindex, tele_gdf, spatial_agg_type, cmap, nbin, threshold):
    ...
    if var=='teleconnection':
        ...
        hist_ax.text(0.55, 0.42, 'Drier in\nCP-El Niño\n↓', fontsize=8, ha="center", va="center", color='white',
                    bbox=dict(boxstyle='square,pad=0.2', linewidth=0, facecolor='gray', alpha=0.0),
                    transform=hist_ax.transAxes, rotation=0)
        hist_ax.text(0.55, 0.85, '↑\nWetter in\nCP-El Niño', fontsize=8, ha="center", va="center",
                    bbox=dict(boxstyle='square,pad=0.2', linewidth=0, facecolor='gray', alpha=0.0),
                    transform=hist_ax.transAxes, rotation=0)
    ...
    if var=='teleconnection':
        title_str = 'CP-ENSO Teleconnection, ' + spatial_agg_type
    else:
        title_str = 'Soil Moisture and ENSO C-Index, ' + spatial_agg_type
...
plt.tight_layout()
plt.savefig('/Users/tylerbagwell/Desktop/SuppFig_CP_globalteleconnections.png', dpi=300, pad_inches=0.01)
plt.savefig('/Users/tylerbagwell/Desktop/SuppFig_CP_globalteleconnections.pdf', dpi=300, format='pdf', bbox_inches='tight', pad_inches=0.1)
plt.show()