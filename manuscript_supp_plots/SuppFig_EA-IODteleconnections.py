...
# teleA
pathA = '/Users/tylerbagwell/Documents/Rice_University/CCCV/data/panel_datasets/onset_datasets_state/Onset_Binary_GlobalState_DMI_NOENSOtype2_wGeometry.csv'
...
# teleB
pathB = '/Users/tylerbagwell/Documents/Rice_University/CCCV/data/panel_datasets/onset_datasets_grid/Onset_Binary_Global_DMI_NOENSOtype2_square4_wGeometry.csv'
...
def draw_map(ax, var, label, cindex, tele_gdf, spatial_agg_type, cmap, nbin, threshold):
    ...
    if cindex == 'NINO3':
        index_box = mpatches.Rectangle((-150, -5), 60, 10, 
                                fill=True, facecolor='blue', edgecolor='blue', linewidth=1.5, alpha=0.20,
                                transform=ccrs.PlateCarree())
        ax.add_patch(index_box)
    elif cindex == 'EA-DMI':
    ...
    if var=='teleconnection':
        title_str = 'EA-DMI Teleconnection, ' + spatial_agg_type
    else:
...
plt.tight_layout()
plt.savefig('/Users/tylerbagwell/Desktop/SuppFig_EA-IODteleconnections.png', dpi=300, pad_inches=0.01)
plt.savefig('/Users/tylerbagwell/Desktop/SuppFig_EA-IODteleconnections.pdf', format='pdf', bbox_inches='tight', pad_inches=0.1)
plt.show()