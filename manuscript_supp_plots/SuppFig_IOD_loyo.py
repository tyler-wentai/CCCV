...
path1 = f'{main_path}Onset_Binary_GlobalState_DMItype2_grouped_linear_weaklyaffected_loyo.csv'
path2 = f'{main_path}Onset_Binary_GlobalState_DMItype2_grouped_linear_stronglytele_loyo.csv'
...
fig.tight_layout()
plt.savefig('/Users/tylerbagwell/Desktop/SuppFig_IOD_loyo_linear.png', dpi=300, pad_inches=0.01)
plt.savefig('/Users/tylerbagwell/Desktop/SuppFig_IOD_loyo_linear.pdf', dpi=300, format='pdf', bbox_inches='tight', pad_inches=0.1)
plt.show()
...
# main_path = "/Users/tylerbagwell/Desktop/"
# path1 = f'{main_path}Onset_Binary_GlobalState_DMItype2_grouped_poisson_weaklyaffected_loyo.csv'
# path2 = f'{main_path}Onset_Binary_GlobalState_DMItype2_grouped_poisson_stronglytele_loyo.csv'
# df1 = pd.read_csv(path1)
# df2 = pd.read_csv(path2)
...
# fig.tight_layout()
# plt.savefig('/Users/tylerbagwell/Desktop/SuppFig_IOD_loyo_poisson.png', dpi=300, pad_inches=0.01)
# plt.savefig('/Users/tylerbagwell/Desktop/SuppFig_IOD_loyo_poisson.pdf', dpi=300, format='pdf', bbox_inches='tight', pad_inches=0.1)
# plt.show()
