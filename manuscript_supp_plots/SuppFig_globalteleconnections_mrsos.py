...
path1 = '/Users/tylerbagwell/Documents/Rice_University/CCCV/data/cccv_data/processed_teleconnections/psi_mrsosEEI.nc'
path2 = '/Users/tylerbagwell/Documents/Rice_University/CCCV/data/cccv_data/processed_teleconnections/psi_mrsosECI.nc'
...
ax1.set_title('Cumulative Correlation b/w Soil Moisture & NINO3', fontsize=11)
cax1 = im1.colorbar.ax
cax1.set_title("Cumulative\ncorrelation", fontsize=8)
...
ax2.set_title('Cumulative Correlation b/w Soil Moisture & DMI', fontsize=11)
cax2 = im2.colorbar.ax
cax2.set_title("Cumulative\ncorrelation", fontsize=8)
