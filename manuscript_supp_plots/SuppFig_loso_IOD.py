...
path = '/Users/tylerbagwell/Desktop/Onset_Binary_GlobalState_DMItype2_mod.f_loso.csv'
df = pd.read_csv(path)    
...
fig.tight_layout()
plt.savefig('/Users/tylerbagwell/Desktop/SuppFig_loso_IOD.png', dpi=300, pad_inches=0.01)
plt.savefig('/Users/tylerbagwell/Desktop/SuppFig_loso_IOD.pdf', dpi=300, format='pdf', bbox_inches='tight', pad_inches=0.1)
plt.show()