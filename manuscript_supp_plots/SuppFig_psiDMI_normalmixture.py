...
# A
pathA = '/Users/tylerbagwell/Desktop/panel_datasets/onset_datasets_grid/Onset_Count_Global_DMItype2_square4_wGeometry.csv'
...
ax1.set_title(f'Grid cell-level DMI teleconnection strengths, N={nA}', fontsize=11)
...
ax2.set_title(f'State-level DMI teleconnection strengths, N={nB}', fontsize=11)
...
# plt.savefig('/Users/tylerbagwell/Desktop/manuscript_plots/SuppFig_psiDMI_normalmixture.png', dpi=300, pad_inches=0.01)
plt.show()
