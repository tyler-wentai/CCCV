...
print('\n\nSTART ---------------------\n')
pathA1 = '/Users/tylerbagwell/Documents/Rice_University/CCCV/data/panel_datasets/onset_datasets_state/Onset_Binary_GlobalState_NINO3type2_v3_newonsetdata.csv'
dfA1 = pd.read_csv(pathA1)

pathA2 = '/Users/tylerbagwell/Documents/Rice_University/CCCV/data/panel_datasets/onset_datasets_state/Onset_Binary_GlobalState_NINO3type1_newonsetdata.csv'
dfA2 = pd.read_csv(pathA2)

psiA1 = dfA1.groupby("loc_id")["psi"].first()
psiA2 = dfA2.groupby("loc_id")["psi"].first()

# q66 = np.nanquantile(psiA1, 0.66)          # handles NaNs
# mask = psiA1 > q66
# psiA1 = psiA1[mask]
# psiA2 = psiA2[mask]
...
#
pathB1 = '/Users/tylerbagwell/Documents/Rice_University/CCCV/data/panel_datasets/onset_datasets_grid/Onset_Count_Global_NINO3type2_v3_square4_newonsetdata.csv'
dfB1 = pd.read_csv(pathB1)
psiB1 = dfB1.groupby("loc_id")["psi"].first()

pathB2 = '/Users/tylerbagwell/Documents/Rice_University/CCCV/data/panel_datasets/onset_datasets_grid/Onset_Count_Global_NINO3type1_square4_newonsetdata.csv'
...
for ax, (x, y, title) in zip(axes, pairs):
    ...
    ax.set_xlabel("Type 1 NINO3 Teleconnection Strength")
    ax.set_ylabel("Type 2 NINO3 Teleconnection Strength")
    ax.set_title(title)
    ...
    add_percentile_xaxis(ax, x, offset=36, label="Percentile Rank of Type 1 NINO3 Teleconnection Strength")

plt.suptitle("Comparison of Spatial Units' Type 1 vs. Type 2 NINO3 Teleconnection Strengths", fontsize=12)

plt.tight_layout()
plt.savefig('/Users/tylerbagwell/Documents/Rice_University/CCCV/SuppFigs/SuppFig_tele_type1_vs_type2_NINO3.png', dpi=300, pad_inches=0.01)
plt.show()
