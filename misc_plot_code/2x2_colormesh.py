...
psi = xr.open_dataarray('/Users/tylerbagwell/Desktop/cccv_data/processed_teleconnections/psi_ANI_cai_noENSO_ENSOAvg.nc')
...
c = ax.contourf(lon, lat, variable2, cmap='Reds', vmax=9)
...
ax = axs[0, 0]
c = ax.contourf(lon, lat, variable0, cmap='PRGn', levels=levels)
# gdf2.plot(ax=ax, edgecolor=None, color='white')
...
ax = axs[0, 1]
c = ax.contourf(lon, lat, variable1, cmap='PRGn')
# gdf2.plot(ax=ax, edgecolor=None, color='white')
