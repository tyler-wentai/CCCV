...
plt.scatter(xA, A_est, color=col1, linewidth=2.0, marker='o', zorder=0, label='ENSO')
plt.scatter(xB, B_est, color=col2, linewidth=2.0, marker='v', zorder=0, label='IOD')
plt.scatter(xC, C_est, color=col3, linewidth=2.0, marker='s', zorder=0, label='A. Nino')

plt.plot([xA[0],xA[0]], [Am2_lower, Am2_upper], color=col1, linewidth=2.0)
plt.plot([xA[1],xA[1]], [Am1_lower, Am1_upper], color=col1, linewidth=2.0)
plt.plot([xA[2],xA[2]], [A0_lower, A0_upper], color=col1, linewidth=2.0)
plt.plot([xA[3],xA[3]], [Ap1_lower, Ap1_upper], color=col1, linewidth=2.0)
plt.plot([xA[4],xA[4]], [Ap2_lower, Ap2_upper], color=col1, linewidth=2.0)

plt.plot([xB[0],xB[0]], [Bm2_lower, Bm2_upper], color=col2, linewidth=2.0)
plt.plot([xB[1],xB[1]], [Bm1_lower, Bm1_upper], color=col2, linewidth=2.0)
plt.plot([xB[2],xB[2]], [B0_lower, B0_upper], color=col2, linewidth=2.0)
plt.plot([xB[3],xB[3]], [Bp1_lower, Bp1_upper], color=col2, linewidth=2.0)
plt.plot([xB[4],xB[4]], [Bp2_lower, Bp2_upper], color=col2, linewidth=2.0)

plt.plot([xC[0],xC[0]], [Cm2_lower, Cm2_upper], color=col3, linewidth=2.0)
plt.plot([xC[1],xC[1]], [Cm1_lower, Cm1_upper], color=col3, linewidth=2.0)
plt.plot([xC[2],xC[2]], [C0_lower, C0_upper], color=col3, linewidth=2.0)
plt.plot([xC[3],xC[3]], [Cp1_lower, Cp1_upper], color=col3, linewidth=2.0)
plt.plot([xC[4],xC[4]], [Cp2_lower, Cp2_upper], color=col3, linewidth=2.0)
...
plt.axvspan(+1.5, +2.5, color=colors[4], alpha=0.20, edgecolor='none', linewidth=0.0)
plt.axvspan(+0.5, +1.5, color=colors[3], alpha=0.15, edgecolor='none', linewidth=0.0)
plt.axvspan(-0.5, +0.5, color=colors[2], alpha=0.00, edgecolor='none', linewidth=0.0)
plt.axvspan(-1.5, -0.5, color=colors[1], alpha=0.15, edgecolor='none', linewidth=0.0)
plt.axvspan(-2.5, -1.5, color=colors[0], alpha=0.20, edgecolor='none', linewidth=0.0)
...
plt.text(+1., +0.055, r'$90\%$ credible bands', fontsize=10, color='k', horizontalalignment='center')
...
# # maroon, navy
# plt.plot(df_A1['INDEX_lag0y'], df_A1['estimate__'], color='maroon', label='posterior estimate', linewidth=2.0)
# plt.fill_between(df_A1['INDEX_lag0y'], df_A1['lower__'], df_A1['upper__'], color='r', alpha=0.30, edgecolor=None, label='likely (66% CI)')
# plt.fill_between(df_A2['INDEX_lag0y'], df_A2['lower__'], df_A2['upper__'], color='r', alpha=0.22, edgecolor=None, label='very likely (90% CI)')
# plt.fill_between(df_A3['INDEX_lag0y'], df_A3['lower__'], df_A3['upper__'], color='r', alpha=0.15, edgecolor=None, label='virtually certain (99% CI)')
