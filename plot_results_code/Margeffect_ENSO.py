...
ax1.set_title('Marginal Effect of ENSO (N=73)', fontsize=10, color='black')
...
ax2.legend(handles=handles, labels=labels, handler_map={tuple: HandlerTuple(ndivide=1)}, loc=[0.05,0.5], fontsize=9, frameon=False, title=r'$\Psi$')
