...
path1_h = '/Users/tylerbagwell/Desktop/panel_datasets/results_for_onsets/CE_cindex_lag0y_Onset_Binary_GlobalState_mrsosNINO3_dry_ci90_linear.csv'
path2_h = '/Users/tylerbagwell/Desktop/panel_datasets/results_for_onsets/CE_cindex_lag0y_Onset_Binary_GlobalState_mrsosNINO3_dry_ci90_linear.csv'

path1_l = '/Users/tylerbagwell/Desktop/panel_datasets/results_for_onsets/CE_cindex_lag0y_Onset_Binary_GlobalState_mrsosNINO3_wet_ci90_linear.csv'
path2_l = '/Users/tylerbagwell/Desktop/panel_datasets/results_for_onsets/CE_cindex_lag0y_Onset_Binary_GlobalState_mrsosNINO3_wet_ci90_linear.csv'
...
df1_h['estimate__']     = 100*(df1_h['estimate__'])#/0.004605692
df1_h['upper__']        = 100*(df1_h['upper__'])#/0.004605692
df1_h['lower__']        = 100*(df1_h['lower__'])#/0.004605692

df2_h['estimate__']     = 100*(df2_h['estimate__'])#/0.004605692
df2_h['upper__']        = 100*(df2_h['upper__'])#/0.004605692
df2_h['lower__']        = 100*(df2_h['lower__'])#/0.004605692
...
df1_l['estimate__']     = 100*(df1_l['estimate__'])#/0.004605692
df1_l['upper__']        = 100*(df1_l['upper__'])#/0.004605692
df1_l['lower__']        = 100*(df1_l['lower__'])#/0.004605692

df2_l['estimate__']     = 100*(df2_l['estimate__'])#/0.004605692
df2_l['upper__']        = 100*(df2_l['upper__'])#/0.004605692
df2_l['lower__']        = 100*(df2_l['lower__'])#/0.004605692
...
ax1.axvspan(+0.5, +3.4, color=colors[4], alpha=0.20, edgecolor='none', linewidth=0.0, zorder=0)
...
#
plt.text(+0.0, +7.25, 'Neutral', fontsize=9, color='k', horizontalalignment='center')
plt.text(+1.0,  +7.25, 'El Niño', fontsize=9, color='k', horizontalalignment='left')
plt.text(-1.0,  +7.25, 'La Niña', fontsize=9, color='k', horizontalalignment='right')
...
ax1.set_ylim(0, 2.5)
ax2.set_xlim(-2.00, 3.4)
# ax2.set_ylim(-0.0075, 0.010)

plt.tight_layout()
plt.savefig('/Users/tylerbagwell/Desktop/justin_slidedeck/cindex_margeffect_Onset_Binary_GlobalState_mrsosNINO3_95ci_linearACR.png', dpi=300, bbox_inches='tight', pad_inches=0.1)
plt.show()
...
# path1_h = '/Users/tylerbagwell/Desktop/panel_datasets/results_for_onsets/CE_cindex_lag0y_Onset_Binary_Global_NINO3_state_group_ALL95.csv'
# path2_h = '/Users/tylerbagwell/Desktop/panel_datasets/results_for_onsets/CE_cindex_lag0y_Onset_Binary_Global_NINO3_state_group_ALL95.csv'

# path1_l = '/Users/tylerbagwell/Desktop/panel_datasets/results_for_onsets/CE_cindex_lag0y_Onset_Binary_Global_NINO3_state_group_ALL95.csv'
# path2_l = '/Users/tylerbagwell/Desktop/panel_datasets/results_for_onsets/CE_cindex_lag0y_Onset_Binary_Global_NINO3_state_group_ALL95.csv'
...
# plt.tight_layout()
# plt.savefig('/Users/tylerbagwell/Desktop/justin_slidedeck/cindex_margeffect_Onset_Binary_Global_NINO3_State_95ci_ALLstates_linearACR.png', dpi=300, bbox_inches='tight', pad_inches=0.1)
# plt.show()
