...
path1_h = '/Users/tylerbagwell/Desktop/panel_datasets/results/CE_cindex_lag0y_Onset_Count_Global_NINO3_square4_high95_poisson.csv'
path2_h = '/Users/tylerbagwell/Desktop/panel_datasets/results/CE_cindex_lag0y_Onset_Count_Global_NINO3_square4_high95_poisson.csv'

path1_l = '/Users/tylerbagwell/Desktop/panel_datasets/results/CE_cindex_lag0y_Onset_Count_Global_NINO3_square4_high95_linear.csv'
path2_l = '/Users/tylerbagwell/Desktop/panel_datasets/results/CE_cindex_lag0y_Onset_Count_Global_NINO3_square4_high95_linear.csv'
...
sns.lineplot(x='cindex_lag0y', y='estimate__', data=df2_l, color='dimgray', linestyle='--', ax=ax2)
...
handles = [(line_strong, patch_strong),(line_weak)]
labels = ['Poisson', 'Linear']

# Create a combined legend using HandlerTuple to combine the tuple handles
ax2.legend(handles=handles, labels=labels, handler_map={tuple: HandlerTuple(ndivide=1)}, loc=[0.05,0.5], fontsize=9, frameon=False)
...
plt.tight_layout()
plt.savefig('/Users/tylerbagwell/Desktop/cindex_margeffect_Onset_Count_Global_NINO3_square4_95ci_poisson.png', dpi=300, bbox_inches='tight', pad_inches=0.1)
plt.show()
