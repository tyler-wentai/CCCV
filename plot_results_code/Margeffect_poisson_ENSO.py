...
path1_h = '/Users/tylerbagwell/Desktop/panel_datasets/results/CE_cindex_lag0y_Onset_Count_Global_NINO3_square4_95ci_strong_poisson.csv'
path2_h = '/Users/tylerbagwell/Desktop/panel_datasets/results/CE_cindex_lag0y_Onset_Count_Global_NINO3_square4_95ci_strong_poisson.csv'

path1_l = '/Users/tylerbagwell/Desktop/panel_datasets/results/CE_cindex_lag0y_Onset_Count_Global_NINO3_square4_95ci_weak_poisson.csv'
path2_l = '/Users/tylerbagwell/Desktop/panel_datasets/results/CE_cindex_lag0y_Onset_Count_Global_NINO3_square4_95ci_weak_poisson.csv'
...
df1_h['estimate__']     = df1_h['estimate__']
df1_h['upper__']        = df1_h['upper__']
df1_h['lower__']        = df1_h['lower__']

df2_h['estimate__']     = df2_h['estimate__']
df2_h['upper__']        = df2_h['upper__']
df2_h['lower__']        = df2_h['lower__']
...
df1_l['estimate__']     = df1_l['estimate__']
df1_l['upper__']        = df1_l['upper__']
df1_l['lower__']        = df1_l['lower__']

df2_l['estimate__']     = df2_l['estimate__']
df2_l['upper__']        = df2_l['upper__']
df2_l['lower__']        = df2_l['lower__']
...
ax2.set_ylabel(r'No. of conflicts', fontsize=10, color='black')
...
#
plt.text(+0.0, +7.15, 'Neutral', fontsize=9, color='k', horizontalalignment='center')
plt.text(+1.0,  +7.15, 'El Niño', fontsize=9, color='k', horizontalalignment='left')
plt.text(-1.0,  +7.15, 'La Niña', fontsize=9, color='k', horizontalalignment='right')
...
plt.tight_layout()
plt.savefig('/Users/tylerbagwell/Desktop/justin_slidedeck/cindex_margeffect_Onset_Count_Global_NINO3_square4_95ci_poisson.png', dpi=300, bbox_inches='tight', pad_inches=0.1)
plt.show()
...
# path_ci = "/Users/tylerbagwell/Desktop/panel_datasets/results_for_onsets/cindex_lag0y_Onset_Binary_Global_NINO3_square4.csv"
# path1_h = '/Users/tylerbagwell/Desktop/panel_datasets/results/CE_cindex_lag0y_Onset_Count_Global_NINO3_square4_95ci_ALL_poisson.csv'
# path2_h = '/Users/tylerbagwell/Desktop/panel_datasets/results/CE_cindex_lag0y_Onset_Count_Global_NINO3_square4_95ci_ALL_poisson.csv'

# path1_l = '/Users/tylerbagwell/Desktop/panel_datasets/results/CE_cindex_lag0y_Onset_Count_Global_NINO3_square4_95ci_ALL_poisson.csv'
# path2_l = '/Users/tylerbagwell/Desktop/panel_datasets/results/CE_cindex_lag0y_Onset_Count_Global_NINO3_square4_95ci_ALL_poisson.csv'
...
# ax1.set_title('Marginal Effect of ENSO (N=73)\n Poisson regression (All countries)', fontsize=10, color='black')
...
# plt.tight_layout()
# plt.savefig('/Users/tylerbagwell/Desktop/justin_slidedeck/cindex_margeffect_Onset_Count_Global_NINO3_State_95ci_ALLstates_Poisson.png', dpi=300, bbox_inches='tight', pad_inches=0.1)
# plt.show()
