...
ax.set_title('Cumulative correlation of (CHIRPS, NINO3 Index NDJ) over tropical year (1981-2023)', fontsize=8.5, pad=7)
...
plt.tight_layout()
# plt.savefig('/Users/tylerbagwell/Desktop/RobMAP_ChirpsprecipNINO3_corr.png', dpi=300, bbox_inches='tight', pad_inches=0.1)
plt.show()
