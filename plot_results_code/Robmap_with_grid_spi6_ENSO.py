...
# --- load the data -----------------------------------------------------------
ds  = xr.open_dataset(
    '/Users/tylerbagwell/Desktop/cccv_data/processed_teleconnections/psispi6_NINO3_FINAL.nc'
)
...
index_box1 = mpatches.Rectangle(
    (-150, -5),    # lower-left corner: 20°W, 3°S
     60,           # width: 0°E minus (–20°W)
     10,           # height: 3°N minus (–3°S)
    fill=True,
    facecolor=nino3_color,  # or whatever color you like
    edgecolor='k',
    linewidth=1.5,
    alpha=0.30,
...
ax.set_title('Cumulative correlation of (SPI6, NINO3 Index NDJ) over tropical year', fontsize=8.5, pad=7)
...
plt.tight_layout()
plt.savefig('/Users/tylerbagwell/Desktop/RobMAP_spi6NINO3_corr.png', dpi=300, bbox_inches='tight', pad_inches=0.1)
plt.show()
