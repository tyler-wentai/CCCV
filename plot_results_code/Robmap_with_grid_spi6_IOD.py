...
# --- load the data -----------------------------------------------------------
ds  = xr.open_dataset(
    '/Users/tylerbagwell/Desktop/cccv_data/processed_teleconnections/psispi6_DMI_FINAL.nc'
)
...
dmi_color = 'gainsboro'  # or whatever color you like
...
ax.set_title('Cumulative correlation of (SPI6, Dipole Mode Index SON) over tropical year', fontsize=8.5, pad=7)
...
plt.tight_layout()
plt.savefig('/Users/tylerbagwell/Desktop/RobMAP_spi6DMI_corr.png', dpi=300, bbox_inches='tight', pad_inches=0.1)
plt.show()
