...
cindex1 = prepare_Eindex(file_path='data/CE_index.csv',
                        start_date=datetime(start_year, 1, 1, 0, 0, 0),
                        end_date=datetime(end_year, 12, 1, 0, 0, 0))
...
plt.suptitle('ENSO E-Index', fontsize=11, y=0.925)
...
ax2.set(
    xlabel="Month",
    ylabel=r"Avg. abs. E-Index ($^\circ$C)",
)
ax2.grid(
    True,                # enable grid
    which="major",        # both major and minor ticks
...
plt.tight_layout()
# plt.savefig("/Users/tylerbagwell/Desktop/EIndex_monthlycorrs_and_avgval.png", dpi=300, bbox_inches='tight')
plt.show()
...
# cindex1 = prepare_NINO34(file_path='data/NOAA_NINO34_data.txt',
#                         start_date=datetime(start_year, 1, 1, 0, 0, 0),
#                         end_date=datetime(end_year, 12, 1, 0, 0, 0))
...
# plt.suptitle('ENSO NINO34', fontsize=11, y=0.925)
...
# ax2.set(
#     xlabel="Month",
#     ylabel=r"Avg. abs. NINO34 ($^\circ$C)",
# )
# ax2.grid(
#     True,                # enable grid
#     which="major",        # both major and minor ticks
...
# plt.tight_layout()
# # plt.savefig("/Users/tylerbagwell/Desktop/NINO34_monthlycorrs_and_avgval.png", dpi=300, bbox_inches='tight')
# plt.show()
