...
# Dataset: UcdpPrioRice_GeoArmedConflictOnset_v1.csv


conflict_data_path = '/Users/tylerbagwell/Desktop/cccv_data/conflict_datasets/UcdpPrioRice_GeoArmedConflictOnset_v1.csv'
...
df_cleaned = df_cleaned.loc[df_cleaned['onset4'] == 1]
...
df_cleaned.to_csv('/Users/tylerbagwell/Desktop/cccv_data/conflict_datasets/UcdpPrioRice_GeoArmedConflictOnset_v1_ONSET4_CLEANED.csv', index=False)
